...
var (
	...
	extListOverflowOuter   = "0020000a0005f0f1f2f3f4000a0005f0f1f2f3f4"
	extListOverflowInner   = "0012000a0005f0f1f2f3f4000a0010f0f1f2f3f4"

	// ClientHello test cases
	chRandom = [32]byte{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
	...
	chValidHex = "0304" + hex.EncodeToString(chRandom[:]) + "00" +
		"0006000100020003" + "0100" + extListValidHex
	chOverflowHex = "0304" + hex.EncodeToString(chRandom[:]) + "00" +
		"0006000100020003" + "0100" + extListOverflowOuter
)
...
func TestExtensionListMarshalUnmarshal(t *testing.T) {
	...
	extListOverflowOuter, _ := hex.DecodeString(extListOverflowOuter)
	extListOverflowInner, _ := hex.DecodeString(extListOverflowInner)
...
func TestClientHelloMarshalUnmarshal(t *testing.T) {
	...
	chLen, err = ch.Unmarshal(chValid[:fixedHelloBodyLength-1])
	...
	assertError(t, err, "Unmarshaled a ClientHello invalid extensions")
}
